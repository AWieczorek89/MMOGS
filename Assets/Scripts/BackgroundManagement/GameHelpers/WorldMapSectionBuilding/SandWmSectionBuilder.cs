...
{
    public class SandWmSectionBuilder : IWorldMapSectionBuilder
    {
        ...
        {
            Material groundMaterial = (Material)Resources.Load("Materials/WorldMap/GroundMaterials/GroundSandMaterial", typeof(Material));
        ...
        {
            GameObject decoPrefab = (GameObject)Resources.Load("Prefabs/WorldMap/WorldMapSectionDeco/SandDecoration", typeof(GameObject));
